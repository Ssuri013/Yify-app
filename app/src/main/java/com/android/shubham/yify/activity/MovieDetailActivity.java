...
import com.android.shubham.yify.fragment.MovieDetailFragment;
...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (data == null) {
                ...
                movieId = getIntent().getStringExtra(YifyApp.MOVIE_ID);
    ...
    private void loadMovieDetailsOf(String movieId) {
        ...
        args.putString(YifyApp.MOVIE_ID, movieId);
    ...
    private void loadMoviesOfType(int viewType) {
        SharedPreferences.Editor editor = getSharedPreferences(YifyApp.TABLE_USER, MODE_PRIVATE).edit();
        editor.putInt(YifyApp.LAST_SELECTED, viewType);
        editor.commit();
