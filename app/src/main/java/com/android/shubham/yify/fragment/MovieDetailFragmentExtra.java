...
//import com.android.shubham.yify.model.Credit;
...
//
//public class MovieDetailFragmentExtra extends Fragment {
//
//    // Toolbar
...
////        intent.putExtra(YifyApp.MOVIE_ID, movie.id);
////        intent.putExtra(YifyApp.MOVIE_NAME, movie.title);
////        startActivity(intent);
////    }
////    @OnClick(R.id.button_reviews)
////    public void onReviewsButtonClicked() {
////        Intent intent = new Intent(getContext(), ReviewActivity.class);
////        intent.putExtra(YifyApp.MOVIE_ID, movie.imdbId);
////        intent.putExtra(YifyApp.MOVIE_NAME, movie.title);
////        startActivity(intent);
////    }
...
////        intent.putExtra(YifyApp.CREDIT_TYPE, YifyApp.CREDIT_TYPE_CREW);
////        intent.putExtra(YifyApp.MOVIE_NAME, movie.title);
////        intent.putExtra(YifyApp.CREDIT_LIST, movie.crew);
////        startActivity(intent);
////    }
////    @OnClick(R.id.movie_cast_see_all)
////    public void onSeeAllCastClicked() {
////        Intent intent = new Intent(getContext(), CreditActivity.class);
////        intent.putExtra(YifyApp.CREDIT_TYPE, YifyApp.CREDIT_TYPE_CAST);
////        intent.putExtra(YifyApp.MOVIE_NAME, movie.title);
////        intent.putExtra(YifyApp.CREDIT_LIST, movie.cast);
////        startActivity(intent);
////    }
